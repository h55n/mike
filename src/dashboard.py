...
class SessionRow(QWidget):
    ...
    def _build(self, s: dict):
        ...
        self.preview_lbl.setStyleSheet(
            ...
            f"font-family: 'PT Serif', serif; line-height: 1.5;"
        )
...
class DashboardWindow(QMainWindow):
    ...
    def _build_sidebar(self):
        ...
        sub.setStyleSheet(
            f"color: #666666; font-size: 10px; text-transform: uppercase; letter-spacing: 0.1em; font-family: 'Segoe UI', sans-serif;"
    ...
    def _nav_to(self, key: str):
        ...
        self.stack.setCurrentIndex(
            {"overview": 0, "sessions": 1, "settings": 2}.get(key, 0)
        )
    ...
    def _build_overview_page(self):
        ...
        self.recent_scroll.setHorizontalScrollBarPolicy(
    ...
    def _build_sessions_page(self):
        ...
        self.session_scroll.setHorizontalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAlwaysOff
        )
    ...
    def _update_stats(self):
        ...
        today_words = sum(
            s.get("word_count", 0) for s in self._sessions if _session_date(s) == today
        )
        week_words = sum(
            s.get("word_count", 0)
